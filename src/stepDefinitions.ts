...
type elem<T> = T extends { [key: string]: infer U } ? U : never;

type d = elem<typeof commandDefinitions>;
type keyOfItem = keyof d;

type UnionToIntersection<U> = 
  (U extends any ? (k: U)=>void : never) extends ((k: infer I)=>void) ? I : never

//type d = ReturnType<typeof getStep>;
export type StepDefinition = UnionToIntersection<d>;

export function getStep(stepId: keyof typeof commandDefinitions) {
    return commandDefinitions[stepId]  as StepDefinition;
}
